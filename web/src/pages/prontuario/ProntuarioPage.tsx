...
function agruparPorDia(
  ...
  console.log('triagens:', triagens.map(t => ({ id: t.id, consultaId: t.consultaId })));
  console.log('consultas:', consultas.map(c => ({ id: c.id })));  const triagemPorConsulta = new Map<string, Triagem>(
  ...
  return (
    <Layout>
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 3 }}>
        <Button startIcon={<ArrowBackIcon />} onClick={() => navigate('/consultas')} variant="outlined" size="small">
          Voltar
        </Button>
      </Box>
