...
namespace Vitus.Infrastructure.Migrations
{
    ...
    [Migration("20260718201332_CreateEnfermeiroAuto")]
    partial class CreateEnfermeiroAuto
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vitus.Domain.Entities.Enfermeiro", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_enfermeiro");

                    b.ToTable("enfermeiro", (string)null);
                });

            modelBuilder.Entity("Vitus.Domain.Entities.Exame", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ProntuarioId")
                        .HasDatabaseName("ix_exames_prontuario_id");
            ...
            modelBuilder.Entity("Vitus.Domain.Entities.Exame", b =>
                {
                    b.HasOne("Vitus.Domain.Entities.Prontuario", "Prontuario")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_exames_prontuarios_prontuario_id");
